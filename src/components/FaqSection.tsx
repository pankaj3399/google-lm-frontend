...
const faqItems: FAQItem[] = [
  {
    ...
    answer:
      "Nope! You don't need to know how to code or be an AI expert. MetricsLM is designed to be user-friendly, so you can easily get the insights you need without any technical skills.",
  },
  {
    id: "pricing",
  ...
  },
  {
    ...
    answer:
      "Yes! MetricsLM easily integrates with popular tools like Google Analytics, HotJar, and Microsoft Clarity. You can bring all your data together in one place, so you can get a full picture and make informed decisions without the hassle.",
  },
  {
    id: "reports",
    question: "How can I work on analytics reports with MetricsLM?",
    answer:
      "With MetricsLM, reports are part of customizable templates that use all the data saved in your workspace, including notes and sources. This helps you focus on the insights that matter most—improving your website, increasing traffic, and reducing drop-offs.",
  },
  {
    id: "ai-dropoff",
    question: "How does MetricsLM's AI help reduce drop-offs and improve UX?",
    answer:
      "Our AI analyzes your data to identify where users are dropping off and why. This helps you make changes that improve the user experience—like adjusting page flow or fixing confusing sections—leading to happier users and fewer drop-offs.",
  },
  {
    id: "data-interaction",
...
const FaqSection: React.FC = () => {
  ...
  return (
    <div
      id="_faq"
      className="flex w-screen  sm:flex-row flex-col justify-between mx-auto px-4 py-3 sm:px-6 lg:px-24 mt-5"
    >
        ...
        <div className="">
          <div className="flex flex-col items-center sm:items-start">
            ...
            >
              ...
              />
              <p data-layername="content" className="self-stretch ">
                FAQ
              </p>
            </div>
          </div>
          ...
          <p className="mt-2 sm:text-base text-2xl font-extralight tracking-wide sm:font-normal sm:tracking-normal text-gray-600 w-80">
            Find answers to common questions about MetricsLM, including its
            features, security measures, integration options, and more.
          </p>
        </div>
      </div>
      ...
      <div className="bg-white sm:w-4/5 rounded-2xl shadow-sm divide-y divide-gray-200 px-6 py-6">
        {faqItems.map((item) => (
          <div key={item.id} className="border-b border-gray-200 last:border-0">
            ...
            >
              <p className="pb-5 text-lg sm:text-base tracking-wide sm:tracking-normal  text-gray-900/50 sm:text-gray-600">
                {item.answer}
              </p>
            </div>
          </div>
