    ...
    <div>
      ...
      {type === "button" && (
        <div className="flex gap-2 w-screen p-5 flex-wrap">
          <button
            className={`${
              title === "Integrations" ? "min-w-40 h-40" : "min-w-48 h-48"
            } font-pops flex flex-col items-center justify-center px-4 py-4 text-lg font-medium rounded-3xl border border-gray-300 transition-transform duration-300 transform hover:scale-105 hover:bg-gray-200`}
                ...
                <Dialog>
                  <DialogTrigger asChild>
                    <Button
                      ...
                      onClick={(e) =>
                        handleDeleteClick(e, previousCreation._id)
                      }
                    >
                      {/* <Trash size={18} /> */}
