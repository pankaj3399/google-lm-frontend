            ...
            {integrations.map((integration, indx) => (
              ...
              >
                <span className="text-4xl text-gray-400">
                  {(integration.name === "ChatGPT" && openAiKey) ||
                  (integration.name === "Google Analytics" && propertyId) ? (
            ...
            <div className="grid grid-cols-2  border-t-2 ">
              <div className="flex  items-center justify-center p-2 mt-2 flex-col pr-5 border-r-2">
                ...
                <p className="mt-5 text-[#718096] mb-4 text-base font-sfpro font-medium text=[16px] ">
                  Connect and allow access to your Google Analytics. Once it’s
                  done, select your website below.
                </p>
                ...
                >
                  <option
                    ...
                    disabled
                    selected
                    className="font-sfpro text-[#718096] text-[14px]"
                  >
                ...
                <select
                  ...
                  onChange={(e) => {
                    ...
                    const name = properties.find(
                      (property) => property.name === propertySelected,
                    )?.displayName;
                    fetchReport(e.target.value, name as string);
                  }}
              ...
              <div className="p-5">
                <h3 className="text-base font-semibold  mb-4 mt-5 text-start font-sfpro text-[#718096]">
                  Your Google Analytics Account is not working?
                </h3>
                <ul className="mt-5 space-y-4  text-base font-sfpro list-disc ml-5 font-medium text-[#16px] text-[#718096]">
                  <li className="pt-5 text-start">
                    Make sure you have a <a href="#">Google Analytics</a>{" "}
                    account.
                  </li>
                  <li className="pt-5 text-start font-pops">
                    Make sure you have selected the analytics account and the
                    respective properties & apps from the dropdown.
                  </li>
                </ul>
                <p className="text-sm text-gray-500 mt-4 pt-5 font-pops">
                  *The app will connect to Google Analytics once you click
                  allow.
                </p>
              </div>
            </div>
            ...
            <div className="flex flex-col lg:flex-row gap-8 border-t-2 pt-8">
              ...
              <div className="flex-1 pr-5 ">
                ...
                <p className="text-[#718096] mb-4 text-center font-medium font-sfpro text-sm  ">
                  ...
                  <p className="inline-block text-sm">
                    Your API Key is stored locally on your browser and never
                  </p>{" "}
                  <p className="text-center">sent anywhere else.</p>
                </p>
              ...
              <div className="flex-1">
                ...
                <ul className="space-y-4 text-[#718096] text-base font-medium font-sfpro list-disc pl-5">
                  <li className="pt-5 text-start">
                    Make sure you have an OpenAI account and a valid API key to
                    use ChatGPT. We don't sell API keys.
                  </li>
                  <li className="pt-5 text-start">
                    Make sure you have your billing info added in OpenAI Billing
                    page. Without billing info, your API key will not work.
                  </li>
                </ul>
                <p className="text-sm text-[#718096] mt-4 pt-5 font-medium font-sfpro">
                  *The app will connect to OpenAI API server to check if your
