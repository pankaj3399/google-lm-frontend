...
const SolutionSection: React.FC = () => {
  return (
    <section data-layername="solutionSection1" className="flex overflow-hidden flex-col items-center px-8 pt-10 pb-0 sm:pb-10 w-full bg-white max-md:px-5  max-md:max-w-full">
