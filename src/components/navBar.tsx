    ...
    >
        ...
        > */}
            ...
            >
                <div
                    data-layername="l"
                    className="flex md:gap-10 gap-44 items-center h-full text-center min-w-[240px]"
                >
                    <div
        ...
        {menuOpen && (
               <div className="absolute bg-white shadow-lg shadow-black/50 h-[70vh] w-screen top-20 inset-0 flex justify-center items-center text-start pr-20 z-10 font-sfpro font-medium">
               <div className=" rounded-lg p-4 flex flex-col gap-10 md:hidden">
                   <div
                       data-layername="menuList"
                       className="flex flex-col md:hidden gap-8 items-center self-stretch my-auto text-base font-light leading-none text-gray-600 whitespace-nowrap"
                   >
                       <button
                   ...
                   {clerkId ? (
                       ...
                       >
                           <button
                               ...
                               className="flex justify-center min-w-10 items-center self-stretch px-3 py-4 my-auto text-blue-500 bg-white rounded-lg border border-blue-200 border-solid"
                           >
                               <a
                                   data-layername="text"
                                   className="self-stretch px-2 my-auto min-h-[20px] flex items-center w-32"
