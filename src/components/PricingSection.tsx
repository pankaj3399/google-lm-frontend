      ...
      <div data-layername="container" className="flex flex-col items-center max-w-full w-[1280px]">
        <div data-layername="secitonHeadlingLevel11" className="flex flex-col text-base text-center max-w-[800px] w-[800px] max-md:max-w-full">
          <div className="flex flex-col items-center w-full max-md:max-w-full">
            <div data-layername="smallEyebrowTagLabelStyle1" className="flex gap-2 items-center px-3 py-2 font-medium leading-relaxed text-gray-600 whitespace-nowrap bg-white rounded-3xl border border-solid shadow border-slate-300">
            ...
            <h2 data-layername="headingWrapper" className="flex-1 shrink gap-2 self-stretch mt-4 w-full text-4xl font-bold leading-10 text-neutral-800 max-md:max-w-full">
              Simple, easy pricing plan <br /> for your BI analysts and managers
            </h2>
            <p data-layername="descrWrapper" className="flex-1 shrink gap-2 self-stretch px-5 mt-4 w-full leading-7 text-gray-600 max-w-[820px] max-md:max-w-full">
