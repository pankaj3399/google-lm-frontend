...
const HeroBanner: React.FC = () => {
  ...
  return (
    <section
      data-layername="heroBanner03"
      className="flex flex-col items-center px-8 pt-10 sm:pb-20 pb-0 w-full bg-white max-md:px-5 md:pt-24 max-md:max-w-full"
    >
      <div
      ...
      >
        <div
          data-layername="contentWrapper"
          className="flex flex-col text-base text-center text-gray-600 max-w-[860px] w-[860px] max-md:max-w-full"
        >
          <div className="flex flex-col w-full max-md:max-w-full">
            <div
              data-layername="smallEyebrowTagLabelStyle1"
              className="flex gap-2 items-center self-center px-3 py-2 font-medium leading-relaxed bg-white rounded-3xl border border-solid shadow border-slate-300 max-md:max-w-full"
            >
              <img
                loading="lazy"
                src="https://cdn.builder.io/api/v1/image/assets/TEMP/461ce54fb3ec87478556ef6b821789b1e72375948174a5d5032f531ed101b8b6?placeholderIfAbsent=true&apiKey=185142cafc424ef59bd121ce5895eb95"
                alt=""
            ...
            <h2
              data-layername="aiPoweredAnalyticsSimplified"
              className="mt-5 text-5xl font-bold leading-none text-neutral-800 max-md:max-w-full max-md:text-4xl"
            >
              AI-powered analytics, simplified
            </h2>
            <div
              data-layername="descrWrapper"
              className="flex gap-2 items-start px-20 mt-5 w-full leading-7 max-md:px-5 max-md:max-w-full"
            >
              <p
                data-layername="sayGoodbyeToDataOverloadTurnScatteredMetricsIntoClearActionableInsightsThatDriveEfficientDecisionMakingYouCanTrust"
                className="flex-1 shrink opacity-80 basis-0 max-md:max-w-full"
              >
                Say goodbye to data overload—turn scattered metrics into clear,
                actionable insights that drive efficient decision-making you can
                trust.
              </p>
            </div>
          </div>
        ...
        <img
          src={"/Container.svg"}
          alt="mailLogo"
          className="mt-20 cursor-pointer hidden sm:inline-block"
          onClick={() => navigate("/home")}
        />

        <div className="flex items-center justify-center mx-6 sm:hidden">
          <div className="bg-[url('/Container1.svg')] text-start bg-cover rounded-3xl bg-center w-80 h-full py-10 my-10 flex flex-col justify-center items-center">
